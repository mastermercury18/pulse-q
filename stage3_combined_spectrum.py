...
D_LAMBDA_DT = np.array([0.08, 0.10, 0.09, 0.09])   # nm/°C
...
lam_axis  = np.linspace(1538, 1565, 5000)   # nm
...
plt.savefig('/Users/neha/pulse-q-subsystem-verification/stage3_combined_spec.png',
