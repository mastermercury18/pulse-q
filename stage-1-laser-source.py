...
# We'll model a small manufacturing spread around 1550 nm
LAMBDA_0_BASE = 1550.0  # nm
...
# Thermal drift coefficients (nm/°C) — typical for InGaAsP/InP DFB diodes at 1550 nm
D_LAMBDA_DT = np.array([0.09, 0.10, 0.08, 0.11])  # nm/°C, slight per-laser variation

# Current tuning at 1550 nm DFB is also smaller, ~0.003-0.008 nm/mA
D_LAMBDA_DI = np.array([0.005, 0.006, 0.004, 0.005])  # nm/mA
...
lam_axis = np.linspace(1540, 1562, 2000)
...
plt.savefig('/Users/neha/pulse-q-subsystem-verification/stage1_wavelength_stability.png',
